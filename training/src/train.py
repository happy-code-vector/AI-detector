...
from src.data.loader import AIDetectionDataset, load_custom_dataset
from src.models.model import AIDetectorModel
...
def main():
    ...
    if args.create_sample:
        ...
        sample_path = Path(__file__).parent.parent / "data" / "custom" / "sample.json"
