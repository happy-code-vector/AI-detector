...
def get_shared_config_path() -> Path:
    ...
    # This file is in api/, so go up one level to project root
...
def get_max_sentences() -> int:
    """Get max sentences from shared config."""
    return get_data_config().get("max_sentences", 120)
